...
const STEPS = [
  ...
  {
    title: 'Сообщение',
    body: 'Старый номер мигает на телефоне:\n«Студия в Старом городе — (78, 73) у дороги. $80 в неделю. Без договора, заезжай.»',
  },
  {
    title: 'Вчера',
  ...
  {
    title: 'Нужды',
    body: 'Голод 28% · Сон 35%. Каждый час — минус.\nСильный голод — нельзя бегать. Усталость — засыпание на ходу.',
  },
  {
    title: 'Управление',
  ...
  {
    title: 'Сегодня',
    body: 'Цель №1: снять студию до полуночи.\nИдите к зелёной двери — тайл (78, 73) на тротуаре.\n[E] у двери → «Снять». Внутри пусто — кровати нет.',
  },
  {
    title: 'Потом',
    body: 'После аренды — кровать в мебельном (122, 97) на главной, потом сон дома.\nЗатем еда (112, 97) и работа (94, 97). Стрелка подскажет путь.',
  },
];
